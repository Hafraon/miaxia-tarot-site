    ...
    <section id="testimonials" className="py-16 md:py-24 bg-purple/10">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto" itemScope itemType="https://schema.org/ItemList">
          ...
          <div className="overflow-hidden py-8 px-2 relative">
            
            {/* Кнопки навігації - виправлено позиціонування */}
            <button 
              onClick={goToPrev}
              className="absolute top-1/2 -left-6 md:-left-16 transform -translate-y-1/2 bg-darkblue/80 hover:bg-darkblue text-gold p-3 md:p-4 rounded-full transition-all duration-300 z-20 border-2 border-gold/50 hover:border-gold shadow-lg hover:shadow-xl hover:scale-110"
            ...
            <button 
              onClick={goToNext}
              className="absolute top-1/2 -right-6 md:-right-16 transform -translate-y-1/2 bg-darkblue/80 hover:bg-darkblue text-gold p-3 md:p-4 rounded-full transition-all duration-300 z-20 border-2 border-gold/50 hover:border-gold shadow-lg hover:shadow-xl hover:scale-110"
